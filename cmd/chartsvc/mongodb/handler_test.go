...
func Test_listCharts(t *testing.T) {
	tests := []struct {
		...
		{"no charts", "", []*models.Chart{}, utils.Meta{TotalPages: 1}},
...
func Test_listRepoCharts(t *testing.T) {
	tests := []struct {
		...
		{"repo has no charts", "my-repo", "", []*models.Chart{}, utils.Meta{TotalPages: 1}},
...
func Test_getChartIcon(t *testing.T) {
	tests := []struct {
		...
		},
		{
			"chart has icon",
			nil,
			models.Chart{ID: "my-repo/my-chart", RawIcon: utils.IconBytes(), IconContentType: "image/png"},
			http.StatusOK,
		},
		{
...
func Test_getChartVersionSchema(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			"3.2.1",
			nil,
			models.ChartFiles{ID: "my-repo/my-chart", Schema: utils.TestChartSchema},
			http.StatusOK,
		},
		{
			"chart does not have values.yaml",
